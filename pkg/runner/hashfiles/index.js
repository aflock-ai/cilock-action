            ...
            return __asyncGenerator(this, arguments, function* globGenerator_1() {
              ...
              for (const pattern of this.patterns) {
                ...
                if (
                  ...
                  patterns.push(
                    new internal_pattern_1.Pattern(pattern.negate, pattern.segments.concat("**")),
                  );
                }
              }
              ...
              while (stack.length) {
                ...
                if (stats.isDirectory()) {
                  ...
                  const childItems = (yield __await(fs.promises.readdir(item.path))).map(
                    (x) =>
                      new internal_search_state_1.SearchState(path.join(item.path, x), childLevel),
                  );
      ...
      /***/ (__unused_webpack_module, exports, __nccwpck_require__) => {
        ...
        class Pattern {
          ...
          static fixupPattern(pattern) {
            ...
            const literalSegments = new internal_path_1.Path(pattern).segments.map((x) =>
